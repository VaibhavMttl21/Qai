...
exports.resetPassword = exports.forgotPassword = exports.googleAuth = exports.login = exports.register = exports.verifyOTP = exports.generateOTP = void 0;
...
const verifyOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (existingUser) {
            ...
            const token = jsonwebtoken_1.default.sign({ id: existingUser.id, email: existingUser.email }, process.env.JWT_SECRET, { expiresIn: '1h' } // Token expires in 1 hour
            );
            // Delete OTP record
        ...
        // Generate token
        const token = jsonwebtoken_1.default.sign({ id: user.id, email: user.email, userType: user.userType, isPaid: user.isPaid, name: user.name }, process.env.JWT_SECRET, { expiresIn: '7d' } // Expire in 7 days
        );
...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return yield (0, exports.generateOTP)(req, res);
    }
    catch (error) {
    ...
    try {
        ...
        if (user.userType === 'SCHOOL') {
            ...
            if (user.hasCustomPassword) {
                isValidCredential = yield bcryptjs_1.default.compare(password, user.password);
            }
            // Otherwise, validate with DOB (the original behavior)
            else {
                isValidCredential = yield bcryptjs_1.default.compare(String(dob), user.password);
