...
//     return (
//       <div className=" w-full border-t-2 border-b-2 bg-neutral-900 border-neutral-700 text-neutral-50 overflow-x-hidden">
//         <Board />
//       </div>
//     );
//   };
...
//     return (
//       <div className="w-full sm:w-72 lg:w-60 shrink-0 mb-6 lg:mb-0">
...
export const CustomKanban = () => {
  return (
    <div className="w-full  text-neutral-500 overflow-x-hidden">
      <Board />
    </div>
  );
};
