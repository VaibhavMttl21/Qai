...
export const CountUpStats = () => {
  return (
    <div className="relative mx-auto max-w-3xl px-4 py-20 md:py-24">
      {/* Rotating background PNG (Positioned on the right side) */}
      <div
        className="absolute top-10 inset-y-0 right-0 w-1/2 z-0 h-200px  bg-no-repeat opacity-50"
        style={{
          backgroundImage: 'url("/Gemini.png")', // Replace with your PNG path
          backgroundPosition: "right center", // Align image to the right
          animation: "rotateBg 30s linear infinite", // Animation for rotating
        }}
      ></div>
      ...
      <style>
        {`
          @keyframes rotateBg {
            ...
            100% { transform: rotate(-360deg); } /* Anti-clockwise rotation */
          }
        `}
      </style>
    </div>
