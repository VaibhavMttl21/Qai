...
export const SpringCards = () => {
  return (
    <section className="mt-20 mb=20 px-8 py-24">
      <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
        <Card
          title="First phase"
          subtitle="What is AI, AI in everyday life and Smart study with AI tools."
        />
         <Card
          title="Second phase"
          subtitle="Basics of Machine Learning, Data & Decision Making and Ethics & AI."
          className="bg-indigo-300 sm:-translate-y-6"
        />
        <Card
          title="Third phase"
          subtitle="Real-World Use Cases, Mini Projects and AI Careers."
          className="bg-red-300"
        />
        <Card
          title="Fourth phase"
          subtitle="Final Quiz & Recap, Bonus AI Tools and Certication."
