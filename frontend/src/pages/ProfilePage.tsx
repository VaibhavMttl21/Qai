...
//   const spotlightColor = " rgba(128, 0, 255, 0.3)";
...
//   return (
//     <div className="min-h-screen w-full  flex flex-col items-center justify-center font-santoshi pt-8 ">
//       <motion.div
...
//         }}
//         className="rounded-xl p-8 backdrop-blur-md border border-white/50 text-neutral-700 w-full max-w-md shadow-2xl mb-6"
//       >
